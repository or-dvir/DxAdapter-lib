...
interface IAdapterSelectable<ITEM: IItemBase>: IAdapterBase<ITEM>
{
     ...
     */
    fun getAllSelectedItems() = getFilteredAdapterItems().filter { it is IItemSelectable && it.isSelected }
//    fun getAllSelectedItems() = mAdapterItems.filter { it is IItemSelectable && it.isSelected }
     ...
     */
    fun selectAll() = select(getFilteredAdapterItems(), false)
//    fun selectAll() = select(mAdapterItems, false)
     ...
     */
    fun isInSelectionMode() = getFilteredAdapterItems().find { it is IItemSelectable && it.isSelected } != null
//    fun isInSelectionMode() = mAdapterItems.find { it is IItemSelectable && it.isSelected } != null
     ...
     */
    fun deselectAll() = deselect(getFilteredAdapterItems(), false)
