...
class MyMultiTypeAdapter(mItems: MutableList<DxItem>)
    : DxAdapter<DxItem, RecyclerViewHolder>(mItems)
{
    ...
    //put this here for convenience. define your view holders wherever you see fit
    class ViewHolderWithImage(itemView: View): RecyclerViewHolder(itemView)
    {
        val iv: ImageView = itemView.iv
    }

    //only need this because i need a default type to return from createAdapterViewHolder()
